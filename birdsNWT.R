defineModule(sim, list(
  ...
  inputObjects = bindrows(
    expectsInput(objectName = "usrEmail", objectClass = "character",
                 ...
                 sourceURL = NA),
    expectsInput(objectName = "waterRaster", objectClass = "SpatRaster",
                 desc = "Wetland raster for excluding water from final bird layers. Water == 1",
                 sourceURL = NA),
    expectsInput(objectName = "wetlandRaster", objectClass = "SpatRaster",
                 desc = "Wetland raster for creating upland raster. wetlands == 1",
                 sourceURL = NA),
    expectsInput(objectName = "uplandsRaster", objectClass = "SpatRaster",
    ...
    expectsInput(objectName = "urlStaticLayers", objectClass = "SpatRaster",
    ...
    expectsInput(objectName = "rasterToMatch", objectClass = "SpatRaster",
                 ...
                 sourceURL = "https://drive.google.com/open?id=1P4grDYDffVyVXvMjM-RwzpuH1deZuvL3"),
    expectsInput(objectName = "forestOnly", objectClass = "SpatRaster",
  ...
  outputObjects = bindrows(
    ...
    createsOutput(objectName = "staticLayers", objectClass = "SpatRaster",
                  desc = paste("Raster stack of all static layers (WAT, URBAG,",
                               "lLED25, DEV25 and landform) for the bird models")),
    createsOutput(objectName = "successionLayers", objectClass = "SpatRaster",
    ...
    createsOutput(objectName = "biomassMap", objectClass = "SpatRaster",
    ...
    createsOutput(objectName = "pixelGroupMap", objectClass = "SpatRaster",
